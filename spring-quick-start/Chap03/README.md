...
- [1bc362c](https://github.com/ItzTree/study-archive/commit/1bc362c4cdc4bd80cbf69a5b407f3a3d1dbd9eed)  
  after returning 어드바이스에 JoinPoint를 추가한다. 비즈니스 메소드가 리턴한 결과값을 바인딩할 목적으로 Object 타입의 returnObj를 선언했는데, 이를 **바인드 변수**라고 한다. 이 때, 바인드 변수에 대한 매핑 설정을 스프링 설정 파일에 추가해야 한다.  
